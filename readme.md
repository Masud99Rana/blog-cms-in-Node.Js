...
# Blog+Cms in Node.js
> **Note:** This repository contains the core code of a blog+cms project in Node.js.
...
## About The Project
A content management system (CMS) is a web-based software that allows to build content-oriented websites, like blogs, eCommerce websites, or portfolios. In this project i have developed a cms along with blog.
...
1. Clone the repo
```sh
https://github.com/Masud99Rana/blog-cms-in-Node.Js.git
```
2. Run **npm install**
